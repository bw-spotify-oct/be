package com.lambdaschool.spotifysongsuggester.logging;
...
{
    @Around(value = "@within(com.lambdaschool.spotifysongsuggester.logging.Loggable) || @annotation(com.lambdaschool.spotifysongsuggester.logging.Loggable)")
